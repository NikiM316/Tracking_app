---
name: rework-commits
description: Rework a branch into a sequence of small, semantic commits for review. Use when splitting a branch into reviewable commits, rewriting commit history into logical units, or when the user asks to rework commits.
---
