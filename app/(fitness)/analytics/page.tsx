import { ConsistencyCalendar } from "@/features/fitness/components/analytics/ConsistencyCalendar";
import { ProgressionChart } from "@/features/fitness/components/analytics/ProgressionChart";
import {
    ...
    <section className="space-y-4">
      <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-5">
        ...
        <p className="mt-2 text-sm leading-relaxed text-zinc-400">
          Training days since your first logged workout.
        </p>
      </div>
